    ...
    <div id="tarife" className={classes["info-block"]}>
      ...
      <div className={`${classes["box"]} ${classes["padding"]}`}>
        ...
        <p className={classes["text"]}>
          ...
          ничего больше - 60 EUR, даже если таких документов будет несколько
        ...
        <p className={classes["text"]}>
          ...
          доверенности / справки / дипломы и проч. по списку, то оплата будет 50
          EUR за посылку и еще 60 EUR за документ(ы). Итого: 110 EUR.
        </p>
        <br />
        <p className={classes["text"]}>
          Если к посылке (также до 5 кг) будет идти такой документ, как паспорт/
          права / рабочее удостоверение, то это будет 50 EUR за посылку и 100 EUR
          за документ. Итого: 150 EUR.
        </p>
      </div>
    </div>
  );
