...
export const tarife: SectionsDataType[] = [
  {
    text: (
      <p>
        мебель = <strong>15 EUR за 1 кг</strong>
      </p>
    ),
  },
  {
    text: (
      <p>
        ...
        удостоверения = <strong>100 EUR за один документ</strong> (❗передаются
  ...
  },
  {
    text: (
      <p>
        ...
        свидетельства о рождении, дипломы, справки = <strong>60 EUR</strong>
      </p>
    ),
  },
];
